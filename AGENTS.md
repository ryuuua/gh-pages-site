...
- Sandbox automation: `bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh --token <TOKEN> --repo-id gh-pages-site --repo-name gh-pages-site --branch "$(git rev-parse --abbrev-ref HEAD)"`
