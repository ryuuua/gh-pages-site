...
bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh \
  --token <TOKEN> \
  --repo-id gh-pages-site \
  --repo-name gh-pages-site \
...
実行例:
- `python3 /Users/ryua/code/mcp_sandbox/scripts/dispatch_repo_trigger.py --repo-root /Users/ryua/code/gh-pages-site --token <TOKEN>`
